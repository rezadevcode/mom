    ...
    <div class="page-header">
        <div class="container-fluid">
            <div class="pull-right">
                <a href="<?php echo base_url('admin/home/sponsor/add') ?>" data-toggle="tooltip" title="Add New" class="btn btn-primary"><i class="fa fa-plus"></i></a>
            ...
            <ul class="breadcrumb">
                ...
                <li><a href="<?php echo base_url('admin/home/sponsor') ?>">Sponsor</a></li>
            </ul>
        </div>
    </div>
    <div class="container-fluid">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title"><i class="fa fa-list"></i> Sponsor List</h3>
            </div>
            <div class="panel-body">
                <form action="<?php echo base_url('admin/home/sponsor/delete') ?>" method="post" enctype="multipart/form-data" id="form-slideshow">
...
<tr>
                                            ...
                                            <td class="text-center"><img src="<?php echo base_url('assets/images/sponsor/' . $row['image']) ?>" alt="" class="img-thumbnail" width="40" height="40" /></td>
                                            ...
                                            <td class="text-right"><a class="btn btn-primary" title="" data-toggle="tooltip" href="<?php echo base_url('admin/home/sponsor/edit/' . $row['id']) ?>" data-original-title="Edit"><i class="fa fa-pencil"></i></a></td>
                                        </tr>
