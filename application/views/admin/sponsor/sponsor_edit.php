    ...
    <div class="container-fluid">
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title"><i class="fa fa-pencil"></i> Add Sponsor</h3>
            </div>
            <div class="panel-body">
                <form class="form-horizontal" id="form" enctype="multipart/form-data" method="post" action="<?php echo base_url('admin/home/sponsor/update') ?>">
                            ...
                            <div style="display: inline-block; margin-right: 50px">
                                <div id="container-upload-1" class="upload-holder">
                                    <?php if($result[0]['image'] != '') { ?>
                                        ...
                                        <figure><div><img src="<?php echo base_url('assets/images/sponsor/'.$result[0]['image']) ?>" alt=""></div></figure>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <select name="type" id="input-status" class="form-control">
                                <option value="sponsor" <?php echo ($result[0]['type']== 'sponsor')? 'selected':'' ?> >sponsor</option>
                                <option value="project" <?php echo ($result[0]['type']== 'project')? 'selected':'' ?> >project</option>
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
