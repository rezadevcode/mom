    ...
    <div class="page-header">
        <div class="container-fluid">
            <div class="pull-right">
                ...
                <a class="btn btn-default" title="" data-toggle="tooltip" href="<?php echo base_url('admin/client/icon') ?>" data-original-title="Cancel"><i class="fa fa-reply"></i></a></div>
            <h1>Icon</h1>
            <ul class="breadcrumb">
    ...
    <div class="container-fluid">
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title"><i class="fa fa-pencil"></i> Edit Icon</h3>
            </div>
            <div class="panel-body">
                <form class="form-horizontal" id="form" enctype="multipart/form-data" method="post" action="<?php echo base_url('admin/client/icon/update') ?>">
                    <input type="hidden" name="id" value="<?php echo $result[0]['client_icon_id'] ?>">
                            ...
                            <div style="display: inline-block; margin-right: 50px">
                                <div id="container-upload-1" class="upload-holder">
                                    <?php if($result[0]['image'] != '') { ?>
                                        ...
                                        <figure><div><img src="<?php echo base_url('assets/images/client/'.$result[0]['image']) ?>" alt=""></div></figure>
