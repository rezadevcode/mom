    ...
    <div class="page-header">
        <div class="container-fluid">
            <div class="pull-right">
                <a href="<?php echo base_url('admin/about/milestone/add') ?>" data-toggle="tooltip" title="Add New" class="btn btn-primary"><i class="fa fa-plus"></i></a>
    ...
    <div class="container-fluid">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title"><i class="fa fa-list"></i> Milestone List</h3>
            </div>
            <div class="panel-body">
                <form action="<?php echo base_url('admin/about/milestone/delete') ?>" method="post" enctype="multipart/form-data" id="form-slideshow">
                                ...
                                if ($results) {
                                    foreach ($results as $row) {
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-right"><a class="btn btn-primary" title="" data-toggle="tooltip" href="<?php echo base_url('admin/about/milestone/edit/' . $row['id']) ?>" data-original-title="Edit"><i class="fa fa-pencil"></i></a></td>
                                        </tr>
