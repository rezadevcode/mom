    ...
    <div class="page-header">
        <div class="container-fluid">
            ...
            <ul class="breadcrumb">
                ...
                <li><a href="<?php echo base_url('admin/home/our_team') ?>">Our Team</a></li>
            </ul>
        </div>
    </div>
    <div class="container-fluid">
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title"><i class="fa fa-pencil"></i> Add Our Team</h3>
            </div>
            <div class="panel-body">
                <form class="form-horizontal" id="form" enctype="multipart/form-data" method="post" action="<?php echo base_url('admin/about/our_team/save') ?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input name="whatsapp" placeholder="WhatsApp" class="form-control">
                        </div>
                    </div>
