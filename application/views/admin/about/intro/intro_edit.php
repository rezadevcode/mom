    ...
    <div class="page-header">
        <div class="container-fluid">
            <div class="pull-right">
                ...
                <a class="btn btn-default" title="" data-toggle="tooltip" href="<?php echo base_url('admin/about/intro') ?>" data-original-title="Cancel"><i class="fa fa-reply"></i></a></div>
            <h1>Intro</h1>
            <ul class="breadcrumb">
    ...
    <div class="container-fluid">
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title"><i class="fa fa-pencil"></i> About Intro</h3>
            </div>
            <div class="panel-body">
                <form class="form-horizontal" id="form" enctype="multipart/form-data" method="post" action="<?php echo base_url('admin/about/intro/update') ?>">
