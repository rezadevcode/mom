    ...
    <div class="container-fluid">
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title"><i class="fa fa-pencil"></i> Edit People</h3>
            </div>
            <div class="panel-body">
                <form class="form-horizontal" id="form" enctype="multipart/form-data" method="post" action="<?php echo base_url('admin/about/people/update') ?>">
                    <input type="hidden" name="id" value="<?php echo $result[0]['about_people_id'] ?>">
                            ...
                            <div style="display: inline-block; margin-right: 50px">
                                <div id="container-upload-1" class="upload-holder">
                                    <?php if($result[0]['image'] != '') { ?>
                                        ...
                                        <figure><div><img src="<?php echo base_url('assets/images/about/'.$result[0]['image']) ?>" alt=""></div></figure>
                    ...
                    <div class="form-group required <?php echo ($this->session->userdata('error_position')) ? 'has-error' : ''; ?>">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="position" placeholder="Position" id="input-position" class="form-control" value="<?php echo $result[0]['position'] ?>" />
