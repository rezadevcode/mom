...
<div style="width: 680px;"><a href="<?php echo $store_url; ?>" title="<?php echo $store_name; ?>"><img src="<?php echo $logo; ?>" alt="<?php echo $store_name; ?>" style="margin-bottom: 20px; border: none;" /></a>
  ...
  <table style="border-collapse: collapse; width: 100%; border-top: 1px solid #DDDDDD; border-left: 1px solid #DDDDDD; margin-bottom: 20px;">
    ...
    <tbody>
      ...
      <tr>
        <td style="font-size: 12px;	border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD; text-align: left; padding: 7px;">
            ...
            if ($order_options) {
                ...
                foreach ($order_options as $order_option) {
                    if($order_option['order_product_id'] == $product['order_product_id']) {
                        if ($order_option['price'] > 0) {
                            $opt_price = ' ( +$' . number_format($order_option['price'], 2, '.', '') . ' )';
                            $option_price += $order_option['price'];
                        } else {
                            $opt_price = '';
                        }
                        echo '- ' . $order_option['name'] . ': ' . $order_option['value'] . $opt_price . '<br>';
                    }
                }
            }
            ?>
        ...
        <td style="font-size: 12px;	border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD; text-align: right; padding: 7px;"><?php echo number_format($product['price'], 2, '.', ''); ?></td>
        <?php
        $sub_total = $product['price'] + $option_price;
        ?>
        <td style="font-size: 12px;	border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD; text-align: right; padding: 7px;"><?php echo number_format($sub_total, 2, '.', ''); ?></td>
      </tr>
      <?php } ?>
    </tbody>
    <tfoot>
      <tr>
        ...
        <td style="font-size: 12px;	border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD; text-align: right; padding: 7px;"><?php echo number_format($total, 2, '.', ''); ?></td>
      </tr>
    </tfoot>
  </table>
  ...
  <table style="border-collapse: collapse; width: 100%; border-top: 1px solid #DDDDDD; border-left: 1px solid #DDDDDD; margin-bottom: 20px;">
    <thead>
      <tr>
          <td style="font-size: 12px; border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD; background-color: #EFEFEF; font-weight: bold; text-align: left; padding: 7px; color: #222222;" colspan="3">Order History</td>
      </tr>
      <tr>
        <td style="font-size: 12px; border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD; background-color: #EFEFEF; font-weight: bold; text-align: left; padding: 7px; color: #222222;">Date Added</td>
    ...
    <tbody>
      ...
      <tr>
          <td style="font-size: 12px;	border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD; text-align: left; padding: 7px;"><?php echo date("d/m/Y", strtotime($row['date_added'])); ?></td>
        <td style="font-size: 12px;	border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD; text-align: left; padding: 7px;"><?php echo $row['comment']; ?></td>
        <td style="font-size: 12px;	border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD; text-align: right; padding: 7px;"><?php echo $row['order_status']; ?></td>
      </tr>
      <?php } ?>
    </tbody>
  </table>
