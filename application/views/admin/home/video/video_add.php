    ...
    <div class="page-header">
        <div class="container-fluid">
            <div class="pull-right">
                ...
                <a class="btn btn-default" title="" data-toggle="tooltip" href="<?php echo base_url('admin/about/slideshow') ?>" data-original-title="Cancel"><i class="fa fa-reply"></i></a></div>
            <h1>Slideshow</h1>
            <ul class="breadcrumb">
    ...
    <div class="container-fluid">
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title"><i class="fa fa-pencil"></i> Add Video</h3>
            </div>
            <div class="panel-body">
                <form class="form-horizontal" id="form" enctype="multipart/form-data" method="post" action="<?php echo base_url('admin/about/video/save') ?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="link_video" placeholder="Link video" id="input-title" class="form-control" />
                        </div>
                    </div>
