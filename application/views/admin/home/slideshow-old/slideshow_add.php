    ...
    <div class="container-fluid">
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title"><i class="fa fa-pencil"></i> Add Slideshow</h3>
            </div>
            <div class="panel-body">
                <form class="form-horizontal" id="form" enctype="multipart/form-data" method="post" action="<?php echo base_url('admin/home/slideshow/save') ?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <textarea name="text_left" placeholder="Text Left" id="input-text-left" class="input-text-area"></textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <textarea name="text_right" placeholder="Text Right" id="input-text-right" class="input-text-area"></textarea>
                        </div>
                    </div>
