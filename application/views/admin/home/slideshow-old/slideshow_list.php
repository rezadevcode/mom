                            ...
                            <tbody>
                                ...
                                if ($results) {
                                    foreach ($results as $row) {
                                        ...
                                        <tr>
                                            <td class="text-center"><input type="checkbox" name="selected[]" value="<?php echo $row['home_slideshow_id'] ?>" /></td>
                                            ...
                                            <td class="text-left"><?php echo strip_tags($row['text_left']) ?></td>
                                            <td class="text-left"><?php echo strip_tags($row['text_right']) ?></td>
                                            <td class="text-right"><a class="btn btn-primary" title="" data-toggle="tooltip" href="<?php echo base_url('admin/home/slideshow/edit/' . $row['home_slideshow_id']) ?>" data-original-title="Edit"><i class="fa fa-pencil"></i></a></td>
                                        </tr>
