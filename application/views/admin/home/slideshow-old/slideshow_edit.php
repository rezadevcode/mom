    ...
    <div class="container-fluid">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form class="form-horizontal" id="form" enctype="multipart/form-data" method="post" action="<?php echo base_url('admin/home/slideshow/update') ?>">
                    <input type="hidden" name="id" value="<?php echo $result[0]['home_slideshow_id'] ?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <textarea name="text_left" placeholder="Text Left" id="input-text-left" class="input-text-area"><?php echo $result[0]['text_left'] ?></textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <textarea name="text_right" placeholder="Text Right" id="input-text-right" class="input-text-area"><?php echo $result[0]['text_right'] ?></textarea>
                        </div>
                    </div>
