                                ...
                                if ($list) {
                                    foreach ($list as $row) {
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center"><img src="<?php echo base_url('assets/images/content/' . $row['image']) ?>" alt="" class="img-thumbnail" width="40" height="40" /></td>
                                            <td class="text-left"><?php echo $row['title'] ?></td>
                                            <td class="text-left"><?php echo strip_tags($row['desc']) ?></td>
                                            <td class="text-left"><?php echo $row['link'] ?></td>
                                            <td class="text-right"><a class="btn btn-primary" title="" data-toggle="tooltip" href="<?php echo base_url('admin/home/service/edit/' . $row['id']) ?>" data-original-title="Edit"><i class="fa fa-pencil"></i></a></td>
                                        </tr>
