    ...
    <div class="page-header">
        <div class="container-fluid">
            <div class="pull-right">
                <a href="<?php echo base_url('admin/home/content_element/add') ?>" data-toggle="tooltip" title="Add New" class="btn btn-primary"><i class="fa fa-plus"></i></a>
    ...
    <div class="container-fluid">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title"><i class="fa fa-list"></i> Content List</h3>
            </div>
            <div class="panel-body">
                <form action="<?php echo base_url('admin/home/content_element/delete') ?>" method="post" enctype="multipart/form-data" id="form-slideshow">
                                ...
                                if ($results) {
                                    foreach ($results as $row) {
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-left"><?php echo $row['placement'] ?></td>
                                            <td class="text-left"><?php echo $row['status'] == 1 ? 'enabled' : 'disabled' ?></td>
                                            <td class="text-left"><?php echo $row['added'] ?></td>
                                            <td class="text-right"><a class="btn btn-primary" title="" data-toggle="tooltip" href="<?php echo base_url('admin/home/content_element/edit/' . $row['id']) ?>" data-original-title="Edit"><i class="fa fa-pencil"></i></a></td>
                                        </tr>
