    ...
    <div class="container-fluid">
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title"><i class="fa fa-pencil"></i> Edit Banner</h3>
            </div>
            <div class="panel-body">
                <form class="form-horizontal" id="form" enctype="multipart/form-data" method="post" action="<?php echo base_url('admin/home/banner/update') ?>">
                    <input type="hidden" name="id" value="<?php echo $result[0]['banner_id'] ?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <textarea name="caption" placeholder="Text Left" id="input-text-left" class="input-text-area"><?php echo $result[0]['caption'] ?></textarea>
                        </div>
                    </div>
                            ...
                            <div style="display: inline-block; margin-right: 50px">
                                <div id="container-upload-1" class="upload-holder">
                                    <?php if($result[0]['image'] != '') { ?>
                                        ...
                                        <figure><div><img src="<?php echo base_url('assets/images/banner/'.$result[0]['image']) ?>" alt=""></div></figure>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <select name="deployment" id="input-status" class="form-control">
                                <option value="home" <?php echo ($result[0]['deployment']== 'home')? 'selected':'' ?> >Home</option>
                                <option value="about" <?php echo ($result[0]['deployment']== 'about')? 'selected':'' ?> >About</option>
                                <option value="service" <?php echo ($result[0]['deployment']== 'service')? 'selected':'' ?> >Service</option>
                                <option value="'mom academy" <?php echo ($result[0]['deployment']== 'mom academy')? 'selected':'' ?> >Mom academy</option>
                                <option value="'mom project" <?php echo ($result[0]['deployment']== 'mom project')? 'selected':'' ?> >Mom project</option>
                            </select>
                        </div>
                    </div>
