    ...
    <div class="page-header">
        <div class="container-fluid">
            <div class="pull-right">
                <a href="<?php echo base_url('admin/home/banner/add') ?>" data-toggle="tooltip" title="Add New" class="btn btn-primary"><i class="fa fa-plus"></i></a>
    ...
    <div class="container-fluid">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form action="<?php echo base_url('admin/home/banner/delete') ?>" method="post" enctype="multipart/form-data" id="form-slideshow">
                            ...
                            <tbody>
                                ...
                                if ($results) {
                                    foreach ($results as $row) {
                                        ...
                                        <tr>
                                            <td class="text-center"><input type="checkbox" name="selected[]" value="<?php echo $row['banner_id'] ?>" /></td>
                                            <td class="text-center"><img src="<?php echo base_url('assets/images/banner/' . $row['image']) ?>" alt="" class="img-thumbnail" width="40" height="40" /></td>
                                            <td class="text-left"><?php echo $row['title'] ?></td>
                                            <td class="text-left"><?php echo strip_tags($row['caption']) ?></td>
                                            <td class="text-left"><?php echo $row['deployment'] ?></td>
                                            <td class="text-left"><?php echo $row['status'] == 1 ? 'enabled' : 'disabled' ?></td>
                                            <td class="text-left"><?php echo $row['added'] ?></td>
                                            <td class="text-right"><a class="btn btn-primary" title="" data-toggle="tooltip" href="<?php echo base_url('admin/home/banner/edit/' . $row['banner_id']) ?>" data-original-title="Edit"><i class="fa fa-pencil"></i></a></td>
                                        </tr>
                                    ...
                                    echo '<tr>';
                                    echo '<td class="text-center" colspan="7">No Results!</td>';
                                    echo '</tr>';
                                }
                                ?>
                            </tbody>
