    ...
    <div class="container-fluid">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form class="form-horizontal" id="form" enctype="multipart/form-data" method="post" action="<?php echo base_url('admin/program/update') ?>">
                <input type="hidden" name="id" placeholder="Title" class="form-control" value="<?php echo $result[0]['id'] ?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <textarea name="desc" placeholder="Text Left" id="input-text-left" class="input-text-area"><?php echo $result[0]['desc'] ?></textarea>
                        </div>
                    </div>
