    ...
    <div class="container-fluid">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form class="form-horizontal" id="form" enctype="multipart/form-data" method="post" action="<?php echo base_url('admin/member/save') ?>">
                    
                    <div class="form-group">
                        <label class="col-sm-2 control-label">Member Id</label>
                        <div class="col-sm-10">
                            <input name="member_id" placeholder="Name" class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input name="community" placeholder="Email" class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <textarea name="about" placeholder="About" id="input-text-left" class="input-text-area"></textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <textarea name="desc" placeholder="Description" id="input-text-left" class="input-text-area"></textarea>
                        </div>
                    </div>
