    ...
    <div class="container-fluid">
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title"><i class="fa fa-pencil"></i> Edit Menu</h3>
            </div>
            <div class="panel-body">
                <form class="form-horizontal" id="form" enctype="multipart/form-data" method="post" action="<?php echo base_url('admin/menu/update') ?>">
                    <input type="hidden" name="id" value="<?php echo $result[0]['menu_id'] ?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="slug" placeholder="Slug" id="input-slug" class="form-control" value="<?php echo $result[0]['slug'] ?>" />
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <textarea name="html" placeholder="HTML" id="input-html" class="input-text-area"><?php echo $result[0]['html'] ?></textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="sort_order" placeholder="Sort Order" id="input-sort-order" class="form-control" style="width: 100px" value="<?php echo $result[0]['sort_order'] ?>" />
                        </div>
                    </div>
