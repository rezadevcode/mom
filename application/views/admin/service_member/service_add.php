    ...
    <div class="container-fluid">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form class="form-horizontal" id="form" enctype="multipart/form-data" method="post" action="<?php echo base_url('admin/service/add') ?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="talent" placeholder="Talent">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label">About</label>
                        <div class="col-sm-10">
                            <textarea name="about" placeholder="About" class="input-text-area"></textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <textarea name="description" placeholder="Description" class="input-text-area"></textarea>
                        </div>
                    </div>
