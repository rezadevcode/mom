    ...
    <div class="page-header">
        <div class="container-fluid">
            <div class="pull-right">
                <a href="<?php echo base_url('admin/service/add') ?>" data-toggle="tooltip" title="Add New" class="btn btn-primary"><i class="fa fa-plus"></i></a>
    ...
    <div class="container-fluid">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form action="<?php echo base_url('admin/service/delete') ?>" method="post" enctype="multipart/form-data" id="form-slideshow">
                                ...
                                if ($results) {
                                    foreach ($results as $row) {
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-left"><?php echo strip_tags(word_limiter($row['desc'],10)) ?></td>
                                            <td class="text-left"><?php echo strip_tags(word_limiter($row['about'],10)) ?></td>
                                            ...
                                            <td class="text-right"><a class="btn btn-primary" title="" data-toggle="tooltip" href="<?php echo base_url('admin/service/edit/' . $row['id']) ?>" data-original-title="Edit"><i class="fa fa-pencil"></i></a></td>
                                        </tr>
                                    ...
                                    echo '<tr>';
                                    echo '<td class="text-center" colspan="10">No Results!</td>';
                                    echo '</tr>';
                                }
                                ?>
                            </tbody>
                        </table>
                        <span>Total data Service Member <?php echo $total_row; ?></span>
                        <?php echo $link; ?>
                    </div>
                </form>
            </div>
