...
class Sponsor extends CI_Controller {
    ...
    public function index() {
        ...
        $data['results'] = $this->Model_crud->select('sponsor');
        
        $data['load_view'] = 'admin/sponsor/sponsor_list';
    ...
    public function add() {
        ...
        $data['load_view'] = 'admin/sponsor/sponsor_add';
        $this->load->view('admin/template/backend', $data);
    }
    ...
    public function save() {
        ...
        if($error) {
            redirect('admin/home/sponsor/add');
        }
    ...
    public function edit($id=0) {
        ...
        $data['load_view'] = 'admin/sponsor/sponsor_edit';
        $this->load->view('admin/template/backend', $data);
    }
    ...
    public function update() {
        ...
        if($error) {
            redirect('admin/home/sponsor/edit/'.$id);
        }
